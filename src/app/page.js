...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-20">
      <div className="mb-25 z-10 w-full max-w-6xl items-center justify-between font-mono text-sm lg:flex">
      ...
      <div className="w-full text-light mb-32 grid text-center lg:mb-0 lg:grid-cols-2 lg:text-left">
        ...
        <div className="w-50% py-2 flex flex-col items-center text-left mb-4">
      ...
      <div className="w-full text-primaryDark mt-20 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            ...
            &nbsp; to code outstanding applications using defferent approaches!
          </p>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            ...
            Norway. Used different methods and mostly Agile methodology to track
            roadmaps
          </p>
      ...
      <h3 className="mt-32 text-3xl py-1 text-primary">Portfolio</h3>
      <div>
        <p className="text-md py-2 leading-8 text-gray-500">
          Since I started working as a developer, ux/ui designer and Tech lead I
          worked on projects in defferent sectors, which includes health,
          science, museums, media production, and companies in the oil industry.
        </p>
      </div>
      ...
      <div className="w-full text-light mb-32 grid lg:mb-0 lg:grid-cols-3 text-center shadow-lg rounded-lg p-8 lg-flex justify-center gap-10">
        <div className="text-left shadow-lg-light p-10 rounded-xl my-10">
          <Image
        ...
        <div className="text-left text-light shadow-lg p-10 rounded-xl my-10">
          <Image
